...
来自Youtube大神Mckay Wrigley的分享，视频链接在这里：[https://www.youtube.com/@realmckaywrigley](https://www.youtube.com/@realmckaywrigley)
我把他的Prompt搬运了过来，大家可以看看什么样的prompt是好的prompt
```
...
Finally, I hope you to translate your answer into Chinese. Always respond in 中文
---
```

网上还有一个[Cursor Directory](https://cursor.directory/)的网站，上面有很多prompt可以参考，大家可以去看看。


[Cursor十大使用技巧](https://www.youtube.com/watch?v=eRUb9Hg__DY)